...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(10,20,10,30,40,50,60,70,10,10,10));
        ...
        developers.addAll(Arrays.asList("Alena","Muhtar","Gadir","Ali","Khasyar","Madivar","Muhtar","Muhtar"));

        developers.retainAll(Arrays.asList("Alena","Khasyar","Muhtar"));
        ...
        groceriesList.addAll(Arrays.asList("Eggs","Potatoes","Milk","Tomatoes","Rice","Orange","Strawberries","Blueberries","Paper Towels"));

        //groceriesList.retainAll(Arrays.asList("Eggs","Potatoes","Milk","Tomatoes"));

        groceriesList.removeAll(Arrays.asList("Rice","Orange","Strawberries","Blueberries","Paper Towels"));
